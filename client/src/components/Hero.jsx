  ...
  return (
    <section className="hero-section flex flex-col lg:flex-row items-center justify-between px-8 py-16 bg-transparent" style={{backgroundImage: "url('\htdocs\Projects\Blood_Bank\Blood_bank_Web\src\components\Images')"}}>
      <div className="left-content m-8">
        ...
        <button className="btn-1 bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mb-4 mr-4">
          Looking for Blood
        </button>
        <button className="btn-2 bg-white hover:bg-red-600 text-white-600 font-bold py-2 px-4 border border-red-600 rounded mb-4">
          Donate Blood
        </button>
      </div>
